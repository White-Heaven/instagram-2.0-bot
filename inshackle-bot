C #!/bin/bash
# Inshackle v1.0
# recoded by: DARKHEAVEN
# github.com/White-Heavan/instagram-2.0-bot
...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by darkheaven (thanks to darkhole )\e[0m\n"
}
